...
function genIntro() {
    main.innerHTML=
/*     '<div class="el prev nav" onclick="genOutro()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+ */
    '<div class="super" id="intro">'+
        '<div class="el title">'+
            'ADSE3200 eksamen V22'+
            '<br><br><p class="sub el green"> Tema: Boligpriser i Oslo, 2010-2020</p><br>'+
        '</div>'+
        '<div id ="introMain">'+
            '<p id="sub" class="el"> Kandidatnummer: 640</p>'+
            '<p id="sub2" class="el"> Merk: Denne siden kjører best på Chrome i høye oppløsninger.</p>'+
            '<div class="el">'+
        ...
        '</div>'+
    '</div>'+
    '<div class="el next" id="test1" onclick="genRelative()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
        '<p id="helpTextBtm">Klikk denne pilen for å gå videre</p>'+
    '</div>';
    currentPage = "intro";
}
...
function genRelative() {
    main.innerHTML=
    '<div class="el prev nav" onclick="genIntro()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
        '<p id="helpTextTop">Klikk denne pilen for å gå tilbake</p>'+
    '</div>'+
    '<div class="super" id="relative">'+
        ...
        '</div>'+
        '<div class="el next" id="test1" onclick="genTimeline()">'+
            '<i class="material-icons" style="font-size:62px">forward</i>'+
        '</div>'+
    '</div>'+
...
function genTimeline() {
    main.innerHTML=
    '<div class="el prev nav" onclick="genRelative()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+
    '<div class="super" id="timeline">'+
        ...
        '</div>'+
    '</div>'+
    '<div class="el next id="test1" " onclick="genNurse()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+
    '<footer class="source">Kilde: SSB</footer>'
    ;
...
function genNurse() {
    main.innerHTML=
    '<div class="el prev nav" onclick="genTimeline()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+
    '<div class="super" id="nurse">'+
        ...
        '</div>'+
    '</div>'+
    '<div class="el next" id="test1" onclick="genOutro()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+
...
function genOutro() {
    main.innerHTML=
    '<div class="el prev nav" onclick="genNurse()">'+
       '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'+
    '<div class="super" id="outro">'+
        ...
        '</div>'+
    '</div>'+
    '<div class="el next" id="test1" onclick="genIntro()">'+
        '<i class="material-icons" style="font-size:62px">forward</i>'+
    '</div>'
    ;
    currentPage = "outro";
